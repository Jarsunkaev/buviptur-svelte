...
// Available languages with proper flag SVGs
...
function detectBrowserLanguage() {
  ...
  if (browserLang) {
    ...
    // Check if we support the language family (e.g., 'en-US' -> 'en')
    const langFamily = browserLang.split('-')[0];
    if (supportedLangs.includes(langFamily)) {
      return langFamily;
    }
  }
...
// Helper function to set language and persist it
