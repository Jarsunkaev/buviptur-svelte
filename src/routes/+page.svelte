<script>
  ...
  // Pre-compute services data to prevent re-renders
  let mainServices = [];
  let supportServices = [];
  let destinations = [];
  ...
  let activeDestinationSlide = 0;
  
  // OPTIMIZED: Lightweight intersection observer with better performance
  ...
  // Optimized parallax effect for images
  let parallaxTimeout;
